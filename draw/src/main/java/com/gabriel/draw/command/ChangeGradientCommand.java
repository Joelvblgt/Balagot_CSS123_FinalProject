...
public class ChangeGradientCommand implements Command {
    ...
    public ChangeGradientCommand(AppService appService, boolean isGradient, Color startColor, Color endColor) {
